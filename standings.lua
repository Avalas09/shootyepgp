  ...
  if not T:IsRegistered("sepgp_standings") then
    T:Register("sepgp_standings",
      "children", function()
        ...
        D:AddLine(
          "text", L["Group by pr"],
          "tooltipText", L["Group members by pr."],
          "checked", sepgp_groupbypr,
          "func", function() sepgp_standings:ToggleGroupBy("sepgp_groupbypr") end
        )
        D:AddLine(
          "text", L["Refresh"],
...
-- GLOBALS: sepgp_saychannel,sepgp_groupbyclass,sepgp_groupbyarmor,sepgp_groupbyrole,sepgp_groupbypr,sepgp_raidonly,sepgp_decay,sepgp_minep,sepgp_reservechannel,sepgp_main,sepgp_progress,sepgp_discount,sepgp_log,sepgp_dbver,sepgp_looted
